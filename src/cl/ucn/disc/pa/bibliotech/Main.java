...
public final class Main {
    ...
    //Menu para realizar el prestamo de libros
    ...
    /*
    Menu que edita la informacion del usuario
     */
    ...
    private static void editarNombre(Sistema sistema) {
        sistema.editarNombre();
    }
    /*
    Cambia el apellido del usuario
     */
    private static void editarApellido(Sistema sistema) {
        sistema.editarApellido();
    }
}
